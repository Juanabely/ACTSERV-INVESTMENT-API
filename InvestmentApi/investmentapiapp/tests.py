...
class TransactionPermissionTests(TestCase):
    def setUp(self):
        ...
        self.admin_user = User.objects.create_user(username='adminuser', password='12345', is_staff=True, is_superuser=True)
    ...
    def test_admin_permissions(self):
        ...
        response = self.client.post('/users/', {'username': 'newuser', 'password': 'newpassword', 'email': 'gqkK7@example.com'})
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
    ...
    def test_non_admin_cant_perform_admin_actions(self):
        ...
        response = self.client.post('/users/', {'username': 'newuser', 'password': 'newpassword'})
